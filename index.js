// Copyright (c) 2018-2019, ZentCash Developers
//
...
var privateKey = fs.readFileSync('/home/root/certificates/privkey.pem', 'utf8');
var certificate = fs.readFileSync('/home/root/certificates/fullchain.pem', 'utf8');
const ca = fs.readFileSync('/home/root/certificates/chain.pem', 'utf8');
...
httpsServer.listen(Config.httpPort, Config.bindIp, () => {
